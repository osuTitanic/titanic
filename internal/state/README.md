...
The service is created during startup in [main.go](https://github.com/osuTitanic/titanic/blob/main/services/stern/cmd/web/main.go#L183) and registered under the `"wiki"` key:
