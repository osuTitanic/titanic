...
func TestRenderHtml(t *testing.T) {
	tests := []struct {
		...
		{"quote preserves smileys", "[quote=Alice]hello [smiley]50[/smiley][/quote]", `<div class="quotetitle">Alice wrote:</div><div class="quotecontent">hello <img src="/images/icons/smilies/50.gif"></div>`},
