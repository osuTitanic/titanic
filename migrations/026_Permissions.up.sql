...
INSERT INTO group_permissions (group_id, permission, rejected) VALUES
    ...
    -- Regular
    (1000, 'users.notifications.view', false),
    (1000, 'users.notifications.delete', false),
    (1000, 'users.profile.update', false),
    (1000, 'users.profile.view', false),
    (1000, 'users.friends.delete', false),
    (1000, 'users.friends.create', false),
    (1000, 'users.friends.view', false),
    (1000, 'users.irc.view_token', false),
    (1000, 'users.irc.regenerate_token', false),
    ...
    (1000, 'beatmaps.collaborations.*', false),
    ...
    (1000, 'forum.bookmarks.view', false),
    (1000, 'forum.bookmarks.create', false),
    (1000, 'forum.bookmarks.delete', false),
    (1000, 'forum.subscriptions.view', false),
